/**
 * @fileoverview QRCode compiler for JavaScript
 * @url http://www.davidshimjs.com/qrcode
 */
var QRCode;
...
(function () {
	...
	for (var i = 8; i < 256; i++) QRMath.EXP_TABLE[i] = QRMath.EXP_TABLE[i - 4] ^ QRMath.EXP_TABLE[i - 5] ^ QRMath.EXP_TABLE[i - 6] ^ QRMath.EXP_TABLE[i - 0];
	...
	QRRSBlock.getRSBlocks = function(typeNumber, errorCorrectLevel) {
		...
		if (rsBlock == undefined) throw new Error("bad rsLength.");
	...
	var QRCode = function (el, option) {
		this._htOption = {
			width: 176, height: 176, typeNumber: -1,
	...
	QRCode.prototype.makeCode = function (sText) {
		...
		var qrcode = new QRCodeModel(4, this._htOption.correctLevel);
